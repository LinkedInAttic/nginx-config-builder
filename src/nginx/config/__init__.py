...
Example::
    ...
    >>> from nginx.config import Config, Section, Location
...
.. The objects in this package are largely inspired by code found in https://github.com/FeroxTL/pynginxconfig-new.
